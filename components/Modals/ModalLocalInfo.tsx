...
const ModalLocalInfo = ({ onToggleModal, isOpen }: { onToggleModal: any, isOpen: boolean }) => {

  return (
    <ModalOverlay isOpen={isOpen}>
      <div className=" flex justify-between items-center p-4 border-b">
        <h2 className="text-xl font-semibold text-gray-900">Nouvelle info locale</h2>
